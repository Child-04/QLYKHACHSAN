...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm stiky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">N5 HOTEL</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link me2" href="#">About</a>
        ...
        <form >
          ...
          <div class="modal-body">
            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
              <button type="sumbit" class="btn btn-dark shadow-none">LOGIN</button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form >
          ...
          <button type="sumbit" class="btn btn-dark shadow-none">REGESTER </button>
          </div>
            <!-- <div class="mb-3">
              <label class="form-label">Email address</label>
              <input type="email" class="form-control shadow-none" >
...
<div class="container">
  <div class="row">
    <div class="col-lg-8 col-md-8 p4 mb-lg-0 mb-3 bg-white rounded">
      <iframe class="w-100 rounded" height="320px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1003454.8175597707!2d106.03575264850267!3d10.754096223002087!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317529292e8d3dd1%3A0xf15f5aad773c112b!2zVGjDoG5oIHBo4buRIEjhu5MgQ2jDrSBNaW5oLCBI4buTIENow60gTWluaA!5e0!3m2!1svi!2s!4v1746790143294!5m2!1svi!2s" ></iframe>
    </div>
...
<div class="container-fluid bg-white mt-5">
  <div class="row">
    ...
    <div class="col-lg-4 p-4">
      ...
      <a href="#" class="d-inline-block mb-2 text-dark tex-decoration-none">Home</a>
      <a href="#" class="d-inline-block mb-2 text-dark tex-decoration-none">Rooms</a>
      <a href="#" class="d-inline-block mb-2 text-dark tex-decoration-none">Facilities</a>
      <a href="#" class="d-inline-block mb-2 text-dark tex-decoration-none">Contact us</a>
      <a href="#" class="d-inline-block mb-2 text-dark tex-decoration-none">About</a>
    </div>
    <div class="col-lg-4 p-4">
      <h5 class="mb-3">Follow us</h5>
      <a href="#" class="d-inline-block text-dark tex-decoration-none mb-2">
          <i class="bi bi-twitter me-1"></i>Twitter
      </a><br>
      <a href="#" class="d-inline-block text-dark tex-decoration-none mb-2">
        <i class="bi bi-facebook me-1"></i>Facebook

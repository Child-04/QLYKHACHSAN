                           ...
                           <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="carousel_picture" id="carousel_picture_inp" accept=".jpg,.jpeg,.png,.webp" class="form-control shadow-none" >
                                </div>
                            <div class="modal-footer">
                                ...
                                <button type="button" onclick="add_image()" class="btn custom-bg text-white shadow-none">SUBMIT</button>
                            </div>
                        </div> 
                        </form>
